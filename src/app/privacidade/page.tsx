    ...
    <>
      ...
      <section className="py-16">
        <div className="container max-w-3xl space-y-6 text-sm leading-relaxed text-body-color">
          <p>
            O responsável pelo tratamento é {site.officeName} ({site.lawyerName},
            cédula profissional {site.license}, NIF {site.nif}), com domicílio
            profissional em {site.addressLine}. Contacto: {site.email}.
          </p>
